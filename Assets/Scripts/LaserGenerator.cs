...
{
    [SerializeField, Header("インターバル")] private float _interval;
    [SerializeField, Header("生成する個数")] private int _count;
    [SerializeField, Header("生成するレーザー")] private GameObject _laser;
    ...
    IEnumerator ShootEnumerator()
    {
        while (true)
        {
            for (int i = 0; i < _count; i++)
            {
                ...
                Instantiate(_laser, pos, transform.rotation);
            }
